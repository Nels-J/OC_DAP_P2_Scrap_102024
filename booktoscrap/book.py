...
def get_book_informations(book_url: str) -> dict[str, str]:
    ...
    Args:
        book_url: e.g. 'https://books.toscrape.com/catalogue/sorting-the-beef-from-the-bull-the-science-of-food-fraud-forensics_736/index.html'
